...
| --- | --- | --- | --- | --- | --- | --- |
| Mar 2026 | IH-Challenge: A Training Dataset to Improve Instruction Hierarchy | OpenAI | [Paper](https://arxiv.org/pdf/2603.10521) | instruction hierarchy, robustness | | |
| Jan 2026 | Agentic Reasoning for Large Language Models | UIUC, Meta, Google, etc. | [Paper](https://arxiv.org/pdf/2601.12538) [NotebookLM](https://notebooklm.google.com/notebook/cd25d510-f19f-4a7a-b506-16dde8a954fb?authuser=1) | agentic reasoning | [Github](https://github.com/weitianxin/Awesome-Agentic-Reasoning) | [Review](https://github.com/nabeelxy/llm-watch/blob/main/reviews/agentic-reasoning-llm-jan-2026.md)|
| Jan 2026 | Reasoning Models Generate Societies of Thought | Google DeepMind | [Paper](https://arxiv.org/pdf/2601.10825) [NotebookLM](https://notebooklm.google.com/notebook/705037cf-20fb-4a77-8004-870654eabd1a) | reasoning, wisdom-of-crowds | | [Review](https://github.com/nabeelxy/llm-watch/blob/main/reviews/reasoning-wisdom-of-crowd-google.md)|
| Jan 2026 | Conditional Memory via Scalable Lookup: A New Axis of Sparsity for Large Language Models | Deepseek | [Paper](https://arxiv.org/pdf/2601.07372) [NotebookLM](https://notebooklm.google.com/notebook/4b66faae-c24f-40f4-855b-69357c2891cf)| Engram, lookup | [Github](https://github.com/deepseek-ai/Engram) | [Review](https://github.com/nabeelxy/llm-watch/blob/main/reviews/deepseek_engram.md)|
| Jan 2026 | Extracting books from production language models | arXiv, Stanford | [Paper](https://arxiv.org/pdf/2601.02671) [NotebookLM](https://notebooklm.google.com/notebook/8bee1652-e259-445a-9a8c-02ad5c7201c9)| memorization, privacy, copyright | | [Review](https://github.com/nabeelxy/llm-watch/blob/main/reviews/extract_books.md)|
...
| Dec 2025 | RECURSIVE LANGUAGE MODELS | MIT | [Paper](https://arxiv.org/pdf/2512.24601) [NotebookLM](https://notebooklm.google.com/notebook/a4898d8a-170e-4b63-8205-7518e24939ce)| inference-time scaling, context window scafaulding | | [Review](https://github.com/nabeelxy/llm-watch/blob/main/reviews/recursive-language-models.md)|
...
| Sep 2025 | Self-Adapting Language Models | arXiv | [Paper](https://arxiv.org/pdf/2506.10943) | SFT, self-tuning | [Code](https://jyopari.github.io/posts/seal) | |
...
| Date |Title | Venue | Materials | Tags | Code | Summary |
| --- | --- | --- | --- | --- | --- | --- |
| Mar 2026 | SWE-CI: Evaluating Agent Capabilities in Maintaining Codebases via Continuous Integration | [Paper](https://arxiv.org/pdf/2603.03823) | SWI, CI | | |
...
| Date | Title | Venue | Materials | Tags | Code | Summary |
| --- | --- | --- | --- | --- | --- | --- |
| Nov 2025 | EmbeddingGemma: Powerful and Lightweight Text Representations | Google | [Paper](https://arxiv.org/pdf/2509.20354) [NotebookLM](https://notebooklm.google.com/notebook/fe9a9145-b30e-4d68-9829-4c6dd03ff11a?authuser=1)| gemma3, 500m parameters | | [Review](https://github.com/nabeelxy/llm-watch/blob/main/reviews/embeddinggemma.md)|
...
| Date | Title | Venue | Materials | Tags | Code | Summary |
| --- | --- | --- | --- | --- | --- | --- |
| Oct 2025 | Supervised Reinforcement Learning: From Expert Trajectories to Step-wise Reasoning | Google | [Paper](https://arxiv.org/pdf/2510.25992v1) | RLVR, SFT, supervised RL | | |
| Aug 2025 | Jet-Nemotron: Efficient Language Model with Post Neural Architecture Search | Nvidia | [Paper](https://arxiv.org/abs/2508.15884) [NotebookLM](https://notebooklm.google.com/notebook/cc6ddfc7-5d54-42a3-9f38-ada185c14e2f?authuser=1) | NAS, Distillation, linear attention | [Github](https://github.com/NVlabs/Jet-Nemotron)| |
...
| May 2025 | An In-Depth Investigation of Data Collection in LLM App Ecosystems | IMC 2025 | [Paper](https://arxiv.org/pdf/2408.13247) | data collection, LLM apps | | |
...
### Blog posts
* [2026-03-10] [Blog](https://openai.com/index/instruction-hierarchy-challenge/) Improving instruction hierarchy in frontier LLMs by OpenAI. #instruction-hierarchy #prompt-injection-safe #hardening
...
* [2025-10-30] [Blog](https://openai.com/index/introducing-aardvark/) Introducing Aardvark: OpenAI’s agentic security researcher by OpenAI. #software #vulnerability #repair
...
* [2025-09-29] [Blog](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents) Effective context engineering for AI agents by Anthropic. #context-engineering #prompt-engineering
