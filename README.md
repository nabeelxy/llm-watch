...
| --- | --- | --- | --- | --- | --- | --- |
| Jan 2026 | Conditional Memory via Scalable Lookup: A New Axis of Sparsity for Large Language Models | Deepseek | [Paper](https://arxiv.org/pdf/2601.07372) | Engram, lookup | [Github](https://github.com/deepseek-ai/Engram) | [Review](https://github.com/nabeelxy/llm-watch/blob/main/reviews/deepseek_engram.md)|
